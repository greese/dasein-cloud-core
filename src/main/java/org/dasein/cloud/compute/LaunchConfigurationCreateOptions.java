...
public class LaunchConfigurationCreateOptions {
  ...
  public LaunchConfigurationCreateOptions(final String name, final String imageId, final VirtualMachineProduct size,
                                          final String keyPairName, final String userData, final String providerRoleId,
                                          final Boolean detailedMonitoring, final String[] firewallIds) {
    this.name = name;
  ...
  public LaunchConfigurationCreateOptions(final String name, final String imageId, final VirtualMachineProduct size,
                                          final String keyPairName, final String userData, final String providerRoleId,
                                          final Boolean detailedMonitoring, final String[] firewallIds,
                                          final Boolean associatePublicIPAddress, final Boolean ioOptimized,
                                          final String virtualMachineIdToClone, final VolumeAttachment[] volumeAttachment) {
    this.name = name;
    this.imageId = imageId;
    this.size = size;
    this.keyPairName = keyPairName;
